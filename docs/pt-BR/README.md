...
[CapSolver](https://www.capsolver.com/?utm_source=github&utm_medium=referral&utm_campaign=langroid-captcha-solver-mcp-tool&utm_content=repository-readme) integration example. Este projeto mostra como adicionar uma ferramenta controlada de tratamento de CAPTCHA ao Langroid. Somente para QA, RPA e fluxos próprios autorizados.
